...
<div class="pd-wrap">
    <div class="cards1" id="cards-detail">
        <div class="img-shop-detail">
            ...
            <ul id="imageGallery">
                ...
                <li data-thumb="{{ asset('public/Upload/gallery/'.$gal->gallery_image) }}" data-src="{{ asset('public/Upload/gallery/'.$gal->gallery_image) }}">
                  <img width="100%" alt="{{ $gal->gallery_name }}" style="max-height:600px;" src="{{ asset('public/Upload/gallery/'.$gal->gallery_image) }}" />
                </li>
                @endforeach
            </ul>
        </div>
        ...
        <div class="shop-detail">
            ...
            <div class="size-selector">
                ...
                @if($value->M>0)
                  <label class="radio-label">
                    <input type="radio" name="product_size" checked value="M" onclick="change_m()">
                    <span>M</span>
                ...
                @if($value->S>0)
                  <label class="radio-label">
                    <input type="radio" name="product_size" value="S" onclick="change_s()">
                    <span>S</span>
                ...
                @if($value->XL>0)
                  <label class="radio-label">
                    <input type="radio" name="product_size" value="XL" onclick="change_xl()">
                    <span>XL</span>
            ...
            <span id="change_m" style="display: none;">Còn tồn {{ $value->M }} sản phẩm</span>
            <span id="change_s" style="display: none;">Còn tồn {{ $value->S }} sản phẩm</span>
            <span id="change_xl" style="display: none;">Còn tồn {{ $value->XL }} sản phẩm</span>
            <br>
            <p>Số lượng</p>
...
<div class="parent">
    ...
    <div class="wap-ss-img-lienquan">
        <a href="{{URL::to('/chi-tiet-san-pham/'.$lienquan->product_id)}}"><img class="img-big" width="275px" height="275px" src="{{ asset('public/Upload/product/'.$lienquan->product_image) }}"></a>
        <div class="textleft">
...
<script type="text/javascript">
    function change_xl()
        {
           document.getElementById("change_xl").style.display = 'block';
           document.getElementById("change_s").style.display = 'none';
           document.getElementById("change_m").style.display = 'none';
        }
    function change_s()
        {
           document.getElementById("change_s").style.display = 'block';
           document.getElementById("change_xl").style.display = 'none';
           document.getElementById("change_m").style.display = 'none';
        }
    function change_m()
        {
           document.getElementById("change_m").style.display = 'block';
           document.getElementById("change_s").style.display = 'none';
           document.getElementById("change_xl").style.display = 'none';
        }
</script>
