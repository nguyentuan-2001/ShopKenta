        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="card-front">
                    <a href="{{URL::to('/chi-tiet-san-pham/'.$pro->product_id)}}"><img src="public/Upload/product/{{ $pro->product_image }} "></a>
                </div>
                <div class="card-back">
                    <a href="{{URL::to('/chi-tiet-san-pham/'.$pro->product_id)}}"><img src="public/Upload/product/{{ $pro->product_image2 }} "></a>
                    <div id="add-product">
