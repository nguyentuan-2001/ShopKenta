                        ...
                        <tbody>
                            <tr style="text-align: center; font-size:18px;">
                                <td  style="width:200px;" scope="row">
                                    <a href="{{URL::to('/chi-tiet-san-pham/'.$order->product_id)}}"><img src="{{asset('public/Upload/product/'.$order->product_image)}}" width="100px" height="100px" alt="" /></a>  
                                </td>
                    ...
                    <table class="table">
                      ...
                      @foreach($order1 as $key1 => $order1)
                        <tbody>
                            <tr style="text-align: center; font-size:18px;">
                                <td  style="width:200px;" scope="row">
                                    <a href="{{URL::to('/chi-tiet-san-pham/'.$order1->product_id)}}"><img src="{{asset('public/Upload/product/'.$order->product_image)}}" width="100px" height="100px" alt="" /></a>
                    ...
                    <table class="table">
                      ...
                      @foreach($order2 as $key2 => $or2)
                        <tbody>
                            <tr style="text-align: center; font-size:18px;">
                                <td  style="width:200px;" scope="row">
                                    <img src="{{asset('public/Upload/product/'.$or2->product_image)}}" width="100px" height="100px" alt="" />
                                </td>
                                <td style="text-align: left;width:400px;">
                    ...
                    <table class="table">
                      ...
                      @foreach($order3 as $key3 => $or3)
                        <tbody>
                            <tr style="text-align: center; font-size:18px;">
                                <td  style="width:200px;" scope="row">
                                    <img src="{{asset('public/Upload/product/'.$or3->product_image)}}" width="100px" height="100px" alt="" />
                                </td>
                                <td style="text-align: left;width:400px;">
                    ...
                    <table class="table">
                      ...
                      @foreach($order4 as $key4 => $or4)
                        <tbody>
                            <tr style="text-align: center; font-size:18px;">
                                <td  style="width:200px;" scope="row">
                                    <img src="{{asset('public/Upload/product/'.$or4->product_image)}}" width="100px" height="100px" alt="" />
                                </td>
                                <td style="text-align: left;width:400px;">
                    ...
                    <table class="table">
                      ...
                      @foreach($order5 as $key5 => $or5)
                        <tbody>
                            <tr style="text-align: center; font-size:18px;">
                                <td  style="width:200px;" scope="row">
                                    <img src="{{asset('public/Upload/product/'.$or5->product_image)}}" width="100px" height="100px" alt="" />
                                </td>
                                <td style="text-align: left;width:400px;">
