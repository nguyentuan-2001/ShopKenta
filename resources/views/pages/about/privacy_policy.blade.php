       ...
       <div class="row">
           ...
           <div class="col-lg-9">
               <div class="content-page" style="margin-left: 30px;">
                  ...
                  <h2><span style="font-size:14px"><em>KENTA.VN tôn trọng sự riêng tư, muốn bảo vệ thông tin cá nhân và thông tin thanh toán của bạn. "Chính sách bảo mật" dưới đây là những cam kết mà chúng tôi thực hiện, nhằm tôn trọng và bảo vệ quyền lợi của người truy cập.</em></span></h2>
                  ...
                  <h2><span style="font-size:14px">- Khi khách hàng thực hiện giao dịch/ đăng ký mở tài khoản tại Kenta.vn khách hàng phải cung cấp một số thông tin cần thiết.</span></h2>
                  ...
                  <h2><span style="font-size:14px">- Thông tin khách hàng, cũng như các trao đổi giữa khách hàng và Kenta, đều được lưu trữ và bảo mật bởi hệ thống của Kenta.</span></h2>
                  <h2><span style="font-size:14px">- Kenta có các biện pháp thích hợp về kỹ thuật và an ninh để ngăn chặn việc truy cập , sử dụng trái phép thông tin khách hàng.</span></h2>
                  <h2><span style="font-size:14px"><strong>2.3/&nbsp;Sử dụng thông tin khách hàng</strong></span></h2>
                  <h2><span style="font-size:14px">* Kenta có quyền sử dụng thông tin khách hàng cung cấp để:</span></h2>
                  ...
                  <h2><span style="font-size:14px">- Xử lý đơn đặt hàng và cung cấp dịch vụ, thông tin qua trang web Kenta.vn theo yêu cầu của quý khách.</span></h2>
                  <h2><span style="font-size:14px">- Sử dụng thông tin đã thu thập được từ các cookies nhằm cải thiện trải nghiệm người dùng và chất lượng các dịch vụ của Kenta.vn.</span></h2>
                  <h2><span style="font-size:14px"><strong>3.&nbsp;Liên kết với website khác</strong></span></h2>
                  <h2><span style="font-size:14px">&nbsp;-&nbsp;Khách hàng có trách nhiệm bảo vệ thông tin tài khoản của mình và không cung cấp bất kỳ thông tin nào liên quan đến tài khoản và mật khẩu truy cập trên Kenta.vn trên các website khác.</span></h2>
                  <h2><span style="font-size:14px"><strong>4.&nbsp;Chia sẻ thông tin khách hàng</strong></span></h2>
                  <h2><span style="font-size:14px">KENTA&nbsp;cam kết sẽ không chia sẻ thông tin của khách hàng cho bất kỳ một công ty nào khác ngoại trừ những công ty và các bên thứ ba có liên quan trực tiếp đến việc giao hàng. Chúng tôi có thể tiết lộ hoặc cung cấp thông tin cá nhân của quý khách trong các trường hợp thật sự cần thiết như sau:</span></h2>
                  ...
                  <h2><span style="font-size:14px">Khi khách hàng sử dụng dịch vụ hoặc xem nội dung do KENTA cung cấp, chúng tôi tự động thu thập và lưu trữ một số thông tin trong nhật ký máy chủ. Những thông tin này bao gồm:</span></h2>
                  <h2><span style="font-size:14px">- Các chi tiết về cách khách hàng sử dụng dịch vụ của Kenta chẳng hạn như truy vấn tìm kiếm.</span></h2>
                  ...
                  <h2><span style="font-size:14px">Bất kỳ khi nào khách hàng cần hỗ trợ, xin vui lòng liên hệ với KENTA tại Emai: kentasale@gmail.com - ĐT: 0908.483.900</span></h2>
                  <h2><span style="font-size:14px"><strong>II.&nbsp;Chính sách bảo mật thanh toán</strong></span></h2>
                  <h2><span style="font-size:14px">- Hệ thống thanh toán thẻ trên Kenta.vn được cung cấp bởi các đối tác cổng thanh toán đã được cấp phép hoạt động hợp pháp tại Việt Nam. Do đó, các tiêu chuẩn bảo mật thanh toán thẻ của KENTA đảm bảo tuân thủ theo các tiêu chuẩn bảo mật của Đối tác cộng thanh toán.</span></h2>
                  <h2><span style="font-size:14px">- Ngoài ra, KENTA còn có các tiêu chuẩn bảo mật giao dịch thanh toán riêng để đảm bảo an toàn các thông tin thanh toán của khách hàng.</span></h2>
                  <ul>
                     <li>
                     ...
                     <li>
                        <h2><span style="font-size:14px">Website: kenta.vn</span></h2>
                     </li>
                     <li>
                        <h2><span style="font-size:14px">Email:&nbsp;kentasale@gmail.com</span></h2>
                     </li>
                     <li>
                        <h2><span style="font-size:14px"><strong><em>Địa chỉ cửa hàng Kenta: </em></strong><em>20 Cửu Long, P15, Q10, TP.HCM</em></span></h2>
                     </li>
                  </ul>
               </div>
           </div>
