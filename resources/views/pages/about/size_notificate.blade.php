        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                ...
                <div id="noidung1">
                    ...
                    <center>
                        <img width="50%" src="{{ asset('public/Upload/product/size1.jpg') }}" alt="size1">
                    ...
                    <center>
                        <img width="50%" src="{{ asset('public/Upload/product/size2.png') }}" alt="size1">
                    ...
                    <center>
                        <img width="50%" src="{{ asset('public/Upload/product/size3.png') }}" alt="size1">
                    ...
                    <center>
                        <img width="50%" src="{{ asset('public/Upload/product/size4.jpg') }}" alt="size1">
                    ...
                    <center>
                        <img width="50%" src="{{ asset('public/Upload/product/size6.jpg') }}" alt="size1">
                    ...
                    <center>
                        <img width="50%" src="{{ asset('public/Upload/product/size5.jpg') }}" alt="size1">
            ...
            <div class="tab-pane fade" id="review" role="tabpanel" aria-labelledby="review-tab">
                ...
                <div id="noidung2">
                    ...
                    <center>
                        <img width="50%" src="{{ asset('public/Upload/product/size7.png') }}" alt="size1">
                    ...
                    <center>
                        <img width="50%" src="{{ asset('public/Upload/product/size8.png') }}" alt="size1">
                    ...
                    <center>
                        <img width="50%" src="{{ asset('public/Upload/product/size9.png') }}" alt="size1">
            ...
            <div class="tab-pane fade" id="danhgia" role="tabpanel" aria-labelledby="description-tab">
                ...
                <div id="noidung3">
                    ...
                    <center>
                        <img width="50%" src="{{ asset('public/Upload/product/size10.png') }}" alt="size1">
                    ...
                    <center>
                        <img width="50%" src="{{ asset('public/Upload/product/size11.png') }}" alt="size1">
            ...
            <div class="tab-pane fade" id="size" role="tabpanel" aria-labelledby="description-tab">
                ...
                <div id="noidung4">
                    ...
                    <center>
                        <img width="50%" src="{{ asset('public/Upload/product/size12.png') }}" alt="size1">
                        <p>Bảng size áo nam dựa trên cân nặng và chiều cao</p>
                    </center><br>
                    <center>
                        <img width="50%" src="{{ asset('public/Upload/product/size13.png') }}" alt="size1">
                        <p>Bảng size áo nam dựa trên những thông số của cơ thể</p>
                    </center><br>
                    <center>
                        <img width="50%" src="{{ asset('public/Upload/product/size14.png') }}" alt="size1">
                    ...
                    <center>
                        <img width="50%" src="{{ asset('public/Upload/product/size15.png') }}" alt="size1">
                        <p>Bảng size áo nữ dựa trên cân nặng và chiều cao</p>
                    </center><br>
                    <center>
                        <img width="50%" src="{{ asset('public/Upload/product/size16.png') }}" alt="size1">
                        <p>Bảng size áo nữ dựa trên những thông số của cơ thể</p>
                    </center><br>
                    <center>
                        <img width="50%" src="{{ asset('public/Upload/product/size17.png') }}" alt="size1">
                    ...
                    <center>
                        <img width="50%" src="{{ asset('public/Upload/product/size18.png') }}" alt="size1">
                        <p>Bảng size quần áo cho trẻ em dựa trên cân nặng và chiều cao</p>
                    </center><br>
                    <center>
                        <img width="50%" src="{{ asset('public/Upload/product/size19.png') }}" alt="size1">
