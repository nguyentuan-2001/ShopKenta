    ...
    <div class="carousel-inner">
        ...
        @foreach($slider as $key => $slide)
            ...
            <div class="carousel-item {{$i==1 ? 'active' : '' }}">
                <div class="col-sm-12">
                    <img alt="{{$slide->slider_desc}}" src="{{asset('public/Upload/slider/'.$slide->slider_image)}}" width="100%" >
        ...
        <div class="row">
            <div class="col-lg-7 offset-lg-4">
                <div class="banner__item">
                    <div class="banner__item__pic">
                        <img src="{{ asset('public/Upload/product/banner-1.jpg') }}" alt="">
                    </div>
            ...
            <div class="col-lg-5">
                <div class="banner__item banner__item--middle">
                    <div class="banner__item__pic">
                        <img src="{{ asset('public/Upload/product/dalat.png') }}" alt="">
                    </div>
                    <div class="banner__item__text">
            ...
            <div class="col-lg-7">
                <div class="banner__item banner__item--last">
                    <div class="banner__item__pic">
                        <img src="{{ asset('public/Upload/product/banner-6.jpg') }}" alt="">
                    </div>
                    <div class="banner__item__text">
                        <h2>Hàng mới về</h2>
...
<section id="all-product">
    ...
    <div class="list">
        ...
        <div class="product">
            <img src="public/Upload/product/{{ $prod->product_image2 }} ">
            <div>
...
<section id="all-product">
    ...
    <div class="list">
        ...
        <div class="product">
            <img src="public/Upload/product/{{ $pro->product_image2 }} ">
            <div>
