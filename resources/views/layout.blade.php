...
<head>
    ...
    <title>Kenta</title>
    <link rel="shortcut icon" href="{{ asset('public/Frontend/images/logo.png') }}" type="image/png">
    {{--end -------------SEO---------------- --}}
    ...
    <link rel="stylesheet" href="{{ asset('public/Frontend/css/css.css') }}">
    ...
    {{-- <link rel="stylesheet" href="{{ asset('public/Frontend/css/shop_detail.css') }}"> --}}
...
<body>
    ...
    <div id="top-nav" style="height: 40px;background: #212121;">   
        {{-- <marquee direction="right" class="bg-color"><img src="{{ asset('public/Frontend/images/cat1.png') }}" height="40px">Chúc bạn một ngày mới tốt lành :)<img src="{{ asset('public/Frontend/images/cat1.png') }}" height="40px"></marquee>
         --}}
    ...
    <div class="row" style="width:100%;">
        <div class="col-8">
            <a class="navbar-branch" href="{{ URL::to('/') }}" >
               <img src="{{ asset('public/Frontend/images/logo.png') }}" height="70px" style="margin-left: 72%">
           </a>
        </div>
        <div class="col-4">
            <?php
            ...
            <li class="nav-item dropdown" style="list-style-type: none; margin-top:22px; float:right;">
                <a class="nav-link dropdown-toggle" href="{{ URL::to('/edit-customer/'.$customer_id) }}" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img id="img-cus" src="{{ asset('public/Upload/customer/'.$cus->customer_image) }}" height="40" width="40" style="border-radius: 30px;margin-top:-10px;">
    ...
    <div class="row" style="margin: 0px !important">
        <div class="col-sm-3" style="padding: 0px !important">
            <article id="3685" class="location-listing">
                ...
                <div class="location-image">
                    <a href="#">
                      <img  src="{{ asset('public/Frontend/images/facebook.jpg') }}" alt="SP1">    
                    </a>
                </div>
            </article>
        </div>
        <div class="col-sm-3" style="padding: 0px !important">
            <article id="3688" class="location-listing">
                ...
                <div class="location-image">
                  <a href="#">
                      <img src="{{ asset('public/Frontend/images/instagram.jpg') }}" alt="SP2">  </a>
                </div>     
            </article>
        </div>
        <div class="col-sm-3" style="padding: 0px !important">
            <article id="3691" class="location-listing">
                ...
                <div class="location-image">
                  <a href="#">
                      <img width="300" height="169" src="{{ asset('public/Frontend/images/tiktok.png') }}" alt="SP3">  </a>
                </div>
            </article>
        </div>
        <div class="col-sm-3" style="padding: 0px !important">
            <article id="3700" class="location-listing">
                ...
                <div class="location-image">
                  <a href="#">
                      <img width="300" height="169" src="{{ asset('public/Frontend/images/unnamed.png') }}" alt="SP4">          
                    </a>
                </div> 
            </article>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-3 col-sm-5">
                    <div class="footer__widget">
                        <h6>KENTA.COM</h6>
                        <ul>
                            <li><a href="{{ URL::to('/about-us') }}">Giới Thiệu Kenta</a></li>
    ...
    <script src="{{ asset('public/jquery-validation-1.19.5/dist/jquery.validate.min.js') }}"></script>
	<script src="{{ asset('public/Backend/js/catcherror.js') }}"></script>
    ...
    <script src="{{ asset('public/Frontend/js/detail.js') }}"></script>
