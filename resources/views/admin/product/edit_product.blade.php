				...
				<div class="panel-body">
                    ...
                    <div class="form-group">
						...
						<div class="col-sm-5">
                            ...
                            <img src="{{ URL::to('public/Upload/product/'.$pro->product_image ) }}" height="100px" width="150px">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
                            ...
                            <img src="{{ URL::to('public/Upload/product/'.$pro->product_image2 ) }}" height="100px" width="150px">
						</div>
					</div>
                    <div class="form-group">
