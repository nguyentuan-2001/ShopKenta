        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body" style="padding:0px;">
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><strong ><img src="public/Upload/product/{{ $pro->product_image }}" height="100px" width="100px"></strong></td>
                                <td><strong ><img src="public/Upload/product/{{ $pro->product_image2 }}" height="100px" width="100px"></strong></td>
                                ...
                                <td><strong >
                                    <?php
                                        ...
                                        ?>
                                        <a href="{{URL::to ('/unactive-product/'.$pro->product_id) }}"><span class="glyphicon glyphicon-remove-sign"></span></a>
                                        
                                        <?php
                                        } else{
                                        ?>
                                            <a href="{{URL::to ('/active-product/'.$pro->product_id) }}"><span class="glyphicon glyphicon-ok-sign"></span></a>
                                        <?php
                                        }
                                        ?>
                    ...
                    <div class="col-12 text-center" id="btn-xemthem">    {{ $search_product->links('pagination::bootstrap-4') }}</div>
                </div>
            </div>
        </div>
    </div>
