	...
	<div class="row">
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				<div class="panel-heading">Đăng kí auth</div>
				...
				?>
						...
						<fieldset>
                            <div class="form-group">
								<input class="form-control" placeholder="Tên" name="admin_name" value="{{ old('admin_name') }}" type="name" autofocus="">
							</div>
							<div class="form-group">
								<input class="form-control" placeholder="E-mail" name="admin_email" type="email" autofocus="">
							</div>
                            <div class="form-group">
								<input class="form-control" placeholder="SDT" name="admin_phone" type="phone" autofocus="">
							</div>
							<div class="form-group">
								<input class="form-control" placeholder="Địa chỉ" name="admin_address" type="text" autofocus="">
							</div>
							<div class="form-group">
								<input class="form-control" placeholder="Password" name="admin_password" type="password" value="">
							</div>
							
							<input type="submit" class="btn btn-primary" value="Đăng kí" name="login">
						</fieldset>
					</form>
					<a href="{{ url()->previous() }}">Quay lại trang trước</a></li>
				</div>
			</div>
		</div><!-- /.col-->
	</div><!-- /.row -->	
